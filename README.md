...
**NOTE**: The DRAM address functions are described in a [JSON configuration](#json-configuration). You will need to first find a configuration file for your system in [the config directory](config/) or reverse-engineer these functions yourself, e.g., using [DRAMA](https://github.com/IAIK/drama) or [TRResspass' DRAMA](https://github.com/vusec/trrespass/tree/master/drama) and then create a configuration file for your system.
